    ...
    <section id="mission" className="relative bg-white py-12 md:py-16">
      ...
      <PageContainer className="grid grid-cols-1 gap-10 md:grid-cols-12 md:gap-0">
        <div className="md:col-span-7 md:pr-10">
          ...
          <div className="mt-10 space-y-6 text-base leading-jp-body text-ink/85 md:mt-14 md:text-lg">
            <p>
          ...
          <div className="mt-10">
            <a
              href="/about"
              className="inline-flex items-center gap-2 rounded-full bg-ink px-6 py-3 text-[15px] font-medium text-white transition hover:bg-ink/90"
            >
              瀧本ゼミについて知る
              <svg
                viewBox="0 0 24 24"
        ...
        <div className="md:col-span-5">
          <div className="relative h-64 overflow-hidden rounded-2xl md:h-full md:min-h-[600px]">
            <img
